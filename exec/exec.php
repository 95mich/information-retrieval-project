...
?>
        ...
        <link rel="shortcut icon" href="http://cs.unsyiah.ac.id/~mchsan/PI/images/favicon.ico" type="image/x-icon">
        ...
        <link href="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/css/bootstrap.css" rel="stylesheet">
        <link href="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/css/customhasil.css" rel="stylesheet">
        <link href="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/css/coderay.css" rel="stylesheet">
        <!--<link href="/css/grid.css" rel="stylesheet">-->

        <script type="text/javascript" src="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/js/jquery.js"></script>
        <script type="text/javascript" src="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="http://cs.unsyiah.ac.id/~mchsan/PI/exec/style/js/modernizr-latest.js"></script>
...
<?php
  ...
  for($i = 1; $i < $jumlah-1 && $i<=$b[0] && $i<=$tp; $i++) {
    ...
    $judul = page_title("./data/".$temp[1]);
                ...
                echo "<p style='font-size:14;color:#1da750;'>http://cs.unsyiah.ac.id/~mchsan/PI/exec/data/".$temp[1]."</p>";
    echo $isi."...";
    echo "<br><br>";
   }
